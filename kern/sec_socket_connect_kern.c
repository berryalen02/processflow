...
int kprobe__security_socket_connect(struct pt_regs *ctx) {
    ...
    if (address_family == AF_INET) {
        struct ipv4_event_t data4 = {.pid = pid, .uid = uid, .af = address_family, .hook.hookpoint = SOCKET_CONNECT};
        ...
        struct ipv6_event_t data6 = {.pid = pid, .uid = uid, .af = address_family, .hook.hookpoint = SOCKET_CONNECT};
        ...
        struct other_socket_event_t socket_event = {.pid = pid, .uid = uid, .af = address_family, .hook.hookpoint = SOCKET_CONNECT};
